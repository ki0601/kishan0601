...
export const getWorkoutsByDate = async (req, res, next) => {
  try {
    ...
    const query = otherUsers
      ? { userId: { $ne: userId }, date: { $gte: startOfDay, $lt: endOfDay } } // Exclude logged-in user's workouts
      : { userId: userId, date: { $gte: startOfDay, $lt: endOfDay } };

    const todaysWorkouts = await Workout.find(query);
